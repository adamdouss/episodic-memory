...
from model.VSLBase import build_optimizer_and_scheduler, VSLBase  # Updated import
        ...
        for epoch in range(configs.epochs):
            ...
            for data in tqdm(
                ...
                (
                    ...
                    s_labels,
                    e_labels,
                    h_labels,  # This can be removed since we don't need it without QGH
                ) = data
                # prepare features
                ...
                total_loss = loc_loss  # No highlight loss here
